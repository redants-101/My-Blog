# My-Blog
对“https://github.com/ZHENFENG13/My-Blog”这个项目，做了一部分拓展。增加了日志配置，修改了部分获取配置的方式，以及增加了导入WordPress博客的功能。

### 日志配置
目录：My-Blog/src/main/resources/log/logback-spring.xml
```
...
<configuration  scan="true" scanPeriod="60 seconds" debug="false">
    <contextName>my-blog</contextName>

    <springProperty scope="context" name="logging.path" source="logging.path" defaultValue="D:/logs/pmp"/>
...
![my-logo.png](https://github.com/fuchenggang/My-Blog/blob/master/static-files/WordPress.jpg）
